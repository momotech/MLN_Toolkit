...
---  设置时间间隔
---
---@param number_a number  单位：s
---@return Timer 
function _class:interval(number_a)
	return self
end
...
---  设置重复次数，默认无限次（0）
---
---@param number_a number  重复次数，0为无限次
---@return Timer 
...
---  开始计时
---
---@param callback_a function  function(boolean completed) ... end 结束回调，completed：是否完成
---@return Timer 
---@note  当前Timer结束前，反复调用start方法只生效一次
function _class:start(callback_a)
	return self
end
