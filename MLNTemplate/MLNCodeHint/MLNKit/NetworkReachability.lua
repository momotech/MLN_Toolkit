...
---  获取网络状态
---
---@return NetworkState 当前网络状态类型, 见[NetworkState](NetworkState.html)
...
---  设置监听网络状态改变回调
---
---@param callback_a function  网络状态变换的回调，格式为：
---		function(state)
---		 	--- state NetworkState 网络状态, 见[NetworkState](NetworkState.html) 
---		end
---@return NetworkReachability 
function NetworkReachability:setOnNetworkStateChange(callback_a)
	return self
end
